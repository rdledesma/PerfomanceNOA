...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 19:58:22 2024
...
def calculo_MBD_RMS_MAD(Xest, Xval):
    ...
    Xval_medio=np.mean(Xval[msk])
    rMBD = MBD/Xval_medio*100
    rRMS = RMS/Xval_medio*100
    rMAD = MAD/Xval_medio*100
    
    corr = np.corrcoef(Xval[msk], Xest[msk])[0,1]
    
    return rRMS ,rMBD ,rMAD
